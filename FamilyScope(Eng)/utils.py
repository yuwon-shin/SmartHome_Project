...
global activities
activities = ['baseline','Eating','Media Watching', 'Board Game', 'Cleaning']
...
def calculate_features(path, activity:str):  ## here
    ...
    time_intervals={'baseline':[tags[0],tags[1]],
                    'Eating':[tags[2],tags[3]],
                    'Media Watching':[tags[4],tags[5]],
                    'Board Game':[tags[6],tags[7]],
                    'Cleaning':[tags[8],tags[9]]}
...
def convert_to_level(path, activity):
    ...
    merged_eda_df.fillna('4: None', inplace=True)
    ...
    merged_hrv_df.fillna('4: None', inplace=True)
    ...
    merged_active_df.fillna('4: None', inplace=True)
